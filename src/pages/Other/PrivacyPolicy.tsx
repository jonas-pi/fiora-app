...
function PrivacyPolicy({ visible, onClose }: Props) {
    ...
    return (
        <Dialog.Container visible={visible}>
            ...
            <Dialog.Description>
                欢迎使用 fiora APP。我们非常重视您的个人信息和隐私保护，在您使用之前，请务必审慎阅读《隐私政策》，并充分理解协议条款内容。我们将严格按照您同意的各项条款使用您的个人信息，以便为您提供更好的服务。
            </Dialog.Description>
            <TouchableOpacity onPress={handleClickPrivacyPolicy} style={styles.linkContainer}>
                <Text style={styles.text}>查看《隐私政策》</Text>
            </TouchableOpacity>
